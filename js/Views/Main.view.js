sap.ui.jsview(ELEARNING_MANAGEMENT_VIEW_MAIN, {
   
    getControllerName: function() {
      return ELEARNING_MANAGEMENT_CONTROLLER_MAIN;
    },
 
    createContent: function(oController) {
      const toolPage = new sap.tnt.ToolPage(ELEARNING_MANAGEMENT_PAGE_MAIN, { sideExpanded: false });
   ...
   createTitle: function(toolPageHeader) {
      ...
      toolPageHeader.addContent(new sap.m.Title({ text: "E-Learning Management", level: "H1", textAlign: sap.ui.core.TextAlign.Center }));
      toolPageHeader.addContent(new sap.m.ToolbarSpacer());
   },
   ...
   createToolPageMainContent: function(toolPage) {
      const oApp = new sap.m.App(ELEARNING_MANAGEMENT_APP);
